...
let package = Package(
    ...
    targets: [
        .target(
            name: "FlowBase",
            dependencies: [
                .product(name: "FINporter", package: "FINporter"),
                .product(name: "FINporterAllocSmart", package: "FINporterAllocSmart"),
                .product(name: "FINporterFido", package: "FINporterFido"),
                .product(name: "FINporterChuck", package: "FINporterChuck"),
                .product(name: "FINporterTabular", package: "FINporterTabular"),
